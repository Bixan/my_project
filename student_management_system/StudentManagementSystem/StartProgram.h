			...
			else
			{
				...
				case 1:
				{
					...
					if (nStuID < 2147483647 && nStuID > 0 )
					{
						...
						cout << "ID：" << nStuID << " 姓名：" << szStuName << " 的学生相关信息添加成功" << endl;
						cout << "当前学生数量共计：" << StuAVL.GetNodeSize() << " 名" << endl;
				...
				case 2:
				{
					...
					if (nStuID < 2147483647 && nStuID > 0)
					{
						...
						cout << "ID：" << nStuID << " 的学生相关信息删除成功" << endl;
						cout << "当前学生数量共计：" << StuAVL.GetNodeSize() << " 名" << endl;
				...
				case 3:
				{
					...
					if (nStuID < 2147483647 && nStuID > 0)
					{
						...
						cout << "ID：" << nStuID << " 的学生相关信息修改成功" << endl;
						cout << "当前学生数量共计：" << StuAVL.GetNodeSize() << " 名" << endl;
						StuAVL.WirteAVLTreeStuDataToInFile();
						system("pause");
					}
